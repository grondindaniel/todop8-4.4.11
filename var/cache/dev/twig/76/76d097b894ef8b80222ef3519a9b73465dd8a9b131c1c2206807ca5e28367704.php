...
class __TwigTemplate_82644ea3fadcd8f6d33474d0fc849437e38708bfc7aae029e2d4870b74d120d2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"row\">
        ...
        <a href=\"";
            // line 13
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("finish_list");
            echo "\" class=\"btn btn-primary\">Consulter la liste des tâches terminées</a>
        ";
        }
        // line 15
        echo "    </div>
";
    ...
    {
        return array (  110 => 15,  105 => 13,  101 => 12,  96 => 11,  94 => 10,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"row\">
        ...
        <a href=\"{{ path('finish_list') }}\" class=\"btn btn-primary\">Consulter la liste des tâches terminées</a>
        {% endif %}
    </div>
{% endblock %}
", "default/index.html.twig", "/Users/danielgrondin/Desktop/finalproject/app/Resources/views/default/index.html.twig");
    }
}
