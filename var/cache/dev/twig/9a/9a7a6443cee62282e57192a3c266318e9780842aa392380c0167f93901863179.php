...
/* :user:list.html.twig */
class __TwigTemplate_6eaef2c9724f1b0ed90c2e772bf6828666fd9215a7f34f81a2b2bbe0756dc5a3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 8
        echo "    ";
        if ((0 === twig_compare(twig_length_filter($this->env, (isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 8, $this->source); })())), 0))) {
            // line 9
...
{% block body %}
    ...
    {% endif %}
{% endblock %}
", ":user:list.html.twig", "/Users/danielgrondin/Desktop/finalproject/app/Resources/views/user/list.html.twig");
    }
}
