...
/* ::base.html.twig */
class __TwigTemplate_a51ff0eee23aae057cf92bf57e1dc9b456230b3563d780ef6f06e08bd7b7ebd1 extends Template
{
    private $source;
    private $macros = [];
...
<html lang=\"fr\">
    ...
    <body>
        ...
        echo "
                ";
        // line 47
        if (( !twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 47) && (0 !== twig_compare("login", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 47), "attributes", [], "any", false, false, false, 47), "get", [0 => "_route"], "method", false, false, false, 47))))) {
            // line 48
            echo "                <a href=\"";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 54), "flashBag", [], "any", false, false, false, 54), "get", [0 => "success"], "method", false, false, false, 54));
        ...
        // line 60
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 60), "flashBag", [], "any", false, false, false, 60), "get", [0 => "error"], "method", false, false, false, 60));
        foreach ($context['_seq'] as $context["_key"] => $context["flash_message"]) {
            // line 61
...
";
    ...
    {
        return new Source("", "::base.html.twig", "/Users/danielgrondin/Desktop/finalproject/app/Resources/views/base.html.twig");
    }
}
